            ...
            <form action='#' method='GET' className='hidden lg:block lg:pl-2'>
              ...
              <div className='relative mt-1 lg:w-96'>
                ...
                <input
                  ...
                  name='email'
                  id='topbar-search'
                  className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full pl-9 p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500'
                  placeholder='Search'
                />
              </div>
            </form>
                ...
                >
                  ...
                  <div className='pl-3 w-full'>
                    <div className='text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400'>
                      ...
                      you in a comment:{' '}
                      <span className='font-medium text-primary-700 dark:text-primary-500'>@bonnie.green</span> what do
                      you say?
                    </div>
